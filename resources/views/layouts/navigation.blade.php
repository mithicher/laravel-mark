        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('about') }}" class="font-bold text-lg flex items-center">
                        <x-logo class="mr-2 text-indigo-600 w-8 h-8" />
                        {{ $settings->get('site_name') ?? 'Laravel Mark' }}
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('documents')" :active="request()->routeIs('documents')">
                        {{ $settings->get('document_title') ?? __('Documentation') }}
                    </x-nav-link>
                </div>
